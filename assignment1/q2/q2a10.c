...
int main(void)
{
    ...
    temp = (double **)malloc(10 * sizeof(double *));
    for (i = 0; i < 10; i++)
    {
        w[i] = (double *)malloc(10 * sizeof(double));
        temp[i] = (double *)malloc(10 * sizeof(double));
    }
...
#pragma omp for
    ...
    max_diff = 1.1 * pow(10.0, -2.0);
    while (max_diff > pow(10.0, -2.0))
    {
        diff = 0.0;
        max_diff = 0.0;
